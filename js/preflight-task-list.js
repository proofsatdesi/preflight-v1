...
var isRarelyModified = function(runOb) {
	return (isCTMHandset(runOb)
		...
		|| runOb.part_number.match(/IPN330391/i)
		...
		|| runOb.part_number.match(/C16595/)
...
.constant('preflightTasks', [
	...
	},
	{
		...
		test: function(jobOb) {
			...
			if (jobOb.prop_name.match(/(rush|ship|due|need|)\s*(\d+[\/\\\-\.]\d+|monday|tuesday|wednesday|thursday|friday)/i)) {
				return [{
					type: "info",
